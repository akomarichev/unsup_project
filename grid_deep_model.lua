...
function AE:createAutoencoder(X, K, patch_size)
  ...
  -- Tied weights
  for i = 1, numberOfPatches * numberOfPatches do
    self.decoder:get(4):get(i):get(2).weight = self.encoder:get(2):get(i):get(2).weight:t()
    self.decoder:get(4):get(i):get(2).gradWeight = self.encoder:get(2):get(i):get(2).gradWeight:t()

    self.decoder:get(1):get(i):get(1).weight = self.encoder:get(5):get(i):get(2).weight:t()
    self.decoder:get(1):get(i):get(1).gradWeight = self.encoder:get(5):get(i):get(2).gradWeight:t()
  end
